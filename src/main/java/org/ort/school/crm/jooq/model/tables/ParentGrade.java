...
public class ParentGrade extends TableImpl<ParentGradeRecord> {
    ...
    private static final long serialVersionUID = -52839716;
    ...
    public <O extends Record> ParentGrade(Table<O> child, ForeignKey<O, ParentGradeRecord> key) {
        super(child, key, PARENT_GRADE);
    }
    ...
    public Parent parent() {
        return new Parent(this, Keys.CONSTRAINT_1);
    }

    public Grade grade() {
        return new Grade(this, Keys.CONSTRAINT_13);
    }
